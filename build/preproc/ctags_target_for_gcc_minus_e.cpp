# 1 "c:\\Users\\Isaiah\\Documents\\Arduino\\Sketches\\MMBC_Waterslide_Timer\\MMBC_Waterslide_Timer.ino"
...
*/
# 17 "c:\\Users\\Isaiah\\Documents\\Arduino\\Sketches\\MMBC_Waterslide_Timer\\MMBC_Waterslide_Timer.ino"
...
# 28 "c:\\Users\\Isaiah\\Documents\\Arduino\\Sketches\\MMBC_Waterslide_Timer\\MMBC_Waterslide_Timer.ino" 2
# 29 "c:\\Users\\Isaiah\\Documents\\Arduino\\Sketches\\MMBC_Waterslide_Timer\\MMBC_Waterslide_Timer.ino" 2
# 30 "c:\\Users\\Isaiah\\Documents\\Arduino\\Sketches\\MMBC_Waterslide_Timer\\MMBC_Waterslide_Timer.ino" 2
# 31 "c:\\Users\\Isaiah\\Documents\\Arduino\\Sketches\\MMBC_Waterslide_Timer\\MMBC_Waterslide_Timer.ino" 2
...
void setup() {
  ...
  */
# 49 "c:\\Users\\Isaiah\\Documents\\Arduino\\Sketches\\MMBC_Waterslide_Timer\\MMBC_Waterslide_Timer.ino"
  pinMode(readyLED, (0x1));
...
void checkStart() {
  if (digitalRead(resetButton) == (0x1) && r == false) {
    RTG = true;
    display.clearDisplay();
    display.setTextSize(3);
    display.setCursor(0, 0);
  ...
  */
# 123 "c:\\Users\\Isaiah\\Documents\\Arduino\\Sketches\\MMBC_Waterslide_Timer\\MMBC_Waterslide_Timer.ino"
}
...
void checkStop() {
  ...
  */
# 153 "c:\\Users\\Isaiah\\Documents\\Arduino\\Sketches\\MMBC_Waterslide_Timer\\MMBC_Waterslide_Timer.ino"
}
...
void displayTime() {
  ...
  while (r == true) {
    ...
    */
# 166 "c:\\Users\\Isaiah\\Documents\\Arduino\\Sketches\\MMBC_Waterslide_Timer\\MMBC_Waterslide_Timer.ino"
    checkStop();
    current = millis();
    if (showTime == false) {
      currentTime = current - start;
      ...
      */
# 192 "c:\\Users\\Isaiah\\Documents\\Arduino\\Sketches\\MMBC_Waterslide_Timer\\MMBC_Waterslide_Timer.ino"
      display.clearDisplay();
      display.setTextSize(3); // Draw 2X-scale text
      display.setTextColor(1 /*|< Draw 'on' pixels*/);
      display.setCursor(0, 0);
    ...
    while (r == false) {
      ...
      if (showTime == true) {
        ...
        */
# 229 "c:\\Users\\Isaiah\\Documents\\Arduino\\Sketches\\MMBC_Waterslide_Timer\\MMBC_Waterslide_Timer.ino"
        display.clearDisplay();
        display.setTextSize(3); // Draw 2X-scale text
        display.setTextColor(1 /*|< Draw 'on' pixels*/);
        display.setCursor(0, 0);
